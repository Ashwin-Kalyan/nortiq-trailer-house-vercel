...
const OperationPage = () => {
  ...
  return (
    <>
      ...
      <section className="section-padding bg-white">
        <div className="container-fluid px-3 px-md-4 px-lg-5 position-relative" style={{ maxWidth: '1200px' }}>
          <ScrollReveal>
            <div className="text-center mb-5 mb-md-6">
              <div className="d-inline-flex align-items-center gap-3 gap-md-4 mb-3 mb-md-4 small text-uppercase fw-semibold" style={{ color: '#2d4a7c', fontSize: '0.8rem', letterSpacing: '0.2em' }}>
                <div className="bg-primary-light" style={{ width: '30px', height: '1px' }}></div>
          ...
          {/* Action Buttons */}
          <div className="position-absolute" style={{ bottom: '0', right: '15px', display: 'flex', flexDirection: 'column', gap: '1rem', zIndex: 10 }}>
            <a
              href="#"
              className="d-inline-flex align-items-center justify-content-center gap-2 px-4 py-3 rounded text-decoration-none fw-semibold"
              style={{
            ...
            <a
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.transform = 'translateY(-2px)'
                e.currentTarget.style.boxShadow = '0 4px 12px rgba(201, 169, 98, 0.3)'
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'translateY(0)'
                e.currentTarget.style.boxShadow = 'none'
